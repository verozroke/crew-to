<template>
  <v-dialog v-model="programStore.dialog" style="max-width: 900px;">
    <v-card>
      <div class="upper">
        <v-card-title class="title"> Стать партнером ивента </v-card-title>
        <div @click="programStore.dialog = false" class="close">
